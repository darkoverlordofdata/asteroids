...
class MersenneTwister
  ...
  N = 624
  M = 397
  MATRIX_A = -1727483681 # 0x9908b0df     # constant vector a
  UPPER_MASK = -2147483648 # 0x80000000   # most significant w-r bits
  LOWER_MASK = 2147483647 # 0x7fffffff   # least significant r bits
  ...
  init_by_array: (init_key, key_length) ->
    ...
    while (k>0)
      ...
      @mt[i] &= -1 # 0xffffffff # for WORDSIZE > 32 machines
      i++
      j++
      if (i>=N)
        @mt[0] = @mt[N-1]
    ...
    while (k>0)
      ...
      if (i>=N)
        ...
        i=1
      k--
    @mt[0] = UPPER_MASK # 0x80000000 # MSB is 1; assuring non-zero initial array
    return
