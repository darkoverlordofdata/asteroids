...
Game = (function() {
  Game.prototype.ash = null;

  Game.prototype.rnd = null;

  Game.prototype.reg = null;
  ...
  Game.prototype.hud = null;

  Game.prototype.keyPoll = null;

  Game.prototype.controller = null;

  Game.prototype.name = 'asteroids';
  ...
  Game.create = function() {
    ...
    return new (cc.Layer.extend((function(func, args, ctor) {
  ...
  Game.scene = function() {
    var scene;
    scene = new cc.Scene();
    scene.addChild(Game.create('par1', 'par2'));
    return scene;
  };

  function Game(p1, p2) {
    cc.log('new Game: ', p1, p2);
  }
